    ...
    render() {
        return (
            <div> {/**Div que recebe todas as divs */}
                ...
                {/**Fim do container */}
                {/**Inicio do carousel */}
                <div className="row mx-auto d-none d-sm-none d-md-block" >
                    <div className="col-12">
                ...
                <div className="row mx-auto d-block d-sm-block d-md-none d-lg-none" >
                    <div className="col-12">
                        <div id="comoFuncionasm" className="carousel slide" data-ride="carousel" data-interval="0" style={{ height: "430px" }}>


                            <ul className="carousel-indicators">
                                <li data-target="#comoFuncionasm" data-slide-to="0" className="active"></li>
                                <li data-target="#comoFuncionasm" data-slide-to="1"></li>
                                <li data-target="#comoFuncionasm" data-slide-to="2"></li>
                            </ul>
                            ...
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <div className="row justify-content-center">
                                        <div className="col-sm-6 col-md-6 ">
                                            <h2 className="num" ><b>1-</b></h2>
                                            <h3 className="titulo" ><b>Cadastre-se</b></h3>
                                            <h4 >Seja você prestador ou cliente, é preciso realizar um rápido cadastro para a segurança de todos os usuários</h4>
                                        </div>
                                        <div className="col-sm-6 col-md-5" style={{ paddingLeft: "160px" }}><img src={register} className="img-fluid" /></div>
                                    </div>
                                ...
                                <div className="carousel-item">
                                    <div className="row justify-content-center">
                                        <div className="col-sm-6 col-md-5 ">
                                            <h2 className="num" ><b>2-</b></h2>
                                            <h3 className="titulo" ><b>Busque por um serviço</b></h3>
                                            <h4 className="" >Navegue entre as diversas categorias de serviços no app ou procure por algo específico</h4>
                                        </div>
                                        <div className="col-sm-6 col-md-5" >
                                            <lottie-player src={"https://assets4.lottiefiles.com/datafiles/qSKave3osZaw1QT/data.json"} speed={1.3} style={{ width: "180px", height: "180px", background: "transparent" , paddingLeft:"100px"}} loop autoplay ></lottie-player>
                                ...
                                <div className="carousel-item">
                                    <div className="row justify-content-center">
                                        ...
                                        <div className="col-sm-6 col-md-5 ">
                                            <h2 className="num" ><b>3-</b></h2>
                                            <h3 className="titulo" ><b>Negocie com um prestador</b></h3>
                                            <h4 className="" >Conecte-se com prestadores pertos de você negocie o serviço direto pelo app</h4>
                                        </div>
                                        <div className="col-sm-6 col-md-5" style={{ paddingLeft: "140px" }} ><img src={maos} className="img-fluid" /></div>
                                ...
                                <div className="carousel-item">
                                    <div className="row justify-content-center">
                                        ...
                                        <div className="col-sm-6 col-md-5 ">
                                            <h2 className="num" ><b>4-</b></h2>
                                            <h3 className="titulo" ><b>Tudo pronto</b></h3>
                                            <h4 className="" >Depois de negociar você poderá marcar data e horário para o serviço acontecer e realizar o pagamento pelo app</h4>
                                        </div>
                                        <div className="col-sm-6 col-md-5" style={{ paddingLeft: "140px" }}><img src={beleza} className="img-fluid" /></div>
                            ...
                            <a className="carousel-control-prev" href="#comoFuncionasm" data-slide="prev" >
                                <span><IoIosArrowRoundBack style={{ backgroundColor: "#30305d", fontSize: "56px" }} /></span>
                            </a>
                            <a className="carousel-control-next" href="#comoFuncionasm" data-slide="next" >
                                <span ><IoIosArrowRoundForward style={{ backgroundColor: "#30305d", fontSize: "56px" }} /></span>
                            </a>
                            {/**className="carousel-control-prev-icon" */}
                            {/**className="carousel-control-next-icon" */}
